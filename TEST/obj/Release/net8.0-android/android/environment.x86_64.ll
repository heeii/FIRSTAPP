...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670631, ; uint32_t jnienv_initialize_method_token (0x6001ca7)
	i32 100670630, ; uint32_t jnienv_registerjninatives_method_token (0x6001ca6)
...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1438746101137967626, ; hash 0x13f773f4c84e8a0a, from name: aot-TEST.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TEST.dll.so
		ptr null; void* handle (0x0)
	}, ; 34
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4134918317315432168, ; hash 0x39622e4d46d79ee8, from name: TEST.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TEST.dll.so
		ptr null; void* handle (0x0)
	}, ; 107
	...
	%struct.DSOCacheEntry {
		i64 7605439563343970560, ; hash 0x698bf2fccdd1c100, from name: aot-TEST
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TEST.dll.so
		ptr null; void* handle (0x0)
	}, ; 181
	...
	%struct.DSOCacheEntry {
		i64 8827677644806218438, ; hash 0x7a82360c0254e2c6, from name: libaot-TEST.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TEST.dll.so
		ptr null; void* handle (0x0)
	}, ; 225
	...
	%struct.DSOCacheEntry {
		i64 10906272426810641521, ; hash 0x975adcfcffaf8c71, from name: TEST
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TEST.dll.so
		ptr null; void* handle (0x0)
	}, ; 273
	...
	%struct.DSOCacheEntry {
		i64 17687685494901541966, ; hash 0xf577483e866f8c4e, from name: libaot-TEST
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TEST.dll.so
		ptr null; void* handle (0x0)
	}, ; 454
...
@.env.3 = private unnamed_addr constant [37 x i8] c"ef6f2475-105d-4b30-8274-06d1771c1491\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [21 x i8] c"com.companyname.test\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [19 x i8] c"libaot-TEST.dll.so\00", align 16
